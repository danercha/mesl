                ...
                using (MESLEntities txt = new MESLEntities())
                {
                    ...
                    foreach (TEAM _t in _tms)
                    {
                        ...
                        _teams.Add(new Local_Team
                        {
                            ...
                            PLAYER1 = (!string.IsNullOrEmpty(_t.PLAYER1.ToString())) ? (from p in _players where p.ID == _t.PLAYER1 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER1 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER1 select p).First().AGE.ToString("#.##") + " ]" : "",
                            PLAYER2 = (!string.IsNullOrEmpty(_t.PLAYER2.ToString())) ? (from p in _players where p.ID == _t.PLAYER2 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER2 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER2 select p).First().AGE.ToString("#.##") + " ]" : "",
                            PLAYER3 = (!string.IsNullOrEmpty(_t.PLAYER3.ToString())) ? (from p in _players where p.ID == _t.PLAYER3 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER3 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER3 select p).First().AGE.ToString("#.##") + " ]" : "",
                            PLAYER4 = (!string.IsNullOrEmpty(_t.PLAYER4.ToString())) ? (from p in _players where p.ID == _t.PLAYER4 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER4 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER4 select p).First().AGE.ToString("#.##") + " ]" : "",
                            PLAYER5 = (!string.IsNullOrEmpty(_t.PLAYER5.ToString())) ? (from p in _players where p.ID == _t.PLAYER5 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER5 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER5 select p).First().AGE.ToString("#.##") + " ]" : "",
                            PLAYER6 = (!string.IsNullOrEmpty(_t.PLAYER6.ToString())) ? (from p in _players where p.ID == _t.PLAYER6 select p).First().FNAME.Trim() + " " + (from p in _players where p.ID == _t.PLAYER6 select p).First().LNAME.Trim() + " [ " + (from p in _players where p.ID == _t.PLAYER6 select p).First().AGE.ToString("#.##") + " ]" : "",
