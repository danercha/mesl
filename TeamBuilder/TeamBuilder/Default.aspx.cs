                ...
                using (MESLEntities txt = new MESLEntities())
                {
                    ...
                    foreach (TEAM _t in _tms)
                    {
                        ...
                        _teams.Add(new Local_Team
                        {
                            ...
                            PLAYER1 = (!string.IsNullOrEmpty(_t.PLAYER1.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER1 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER1 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER1 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "", 
                            PLAYER2 = (!string.IsNullOrEmpty(_t.PLAYER2.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER2 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER2 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER2 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "",
                            PLAYER3 = (!string.IsNullOrEmpty(_t.PLAYER3.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER3 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER3 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER3 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "",
                            PLAYER4 = (!string.IsNullOrEmpty(_t.PLAYER4.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER4 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER4 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER4 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "",
                            PLAYER5 = (!string.IsNullOrEmpty(_t.PLAYER5.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER5 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER5 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER5 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "",
                            PLAYER6 = (!string.IsNullOrEmpty(_t.PLAYER6.ToString())) ? (from p in txt.PLAYERs where p.ID == _t.PLAYER6 select p).First().FNAME.Trim() + " " + (from p in txt.PLAYERs where p.ID == _t.PLAYER6 select p).First().LNAME.Trim() + " [ " + (((DateTime.Now - DateTime.Parse((from p in txt.PLAYERs where p.ID == _t.PLAYER6 select p).First().DOB.ToString())).TotalDays) / 365).ToString("#.##") + " ]" : "",
