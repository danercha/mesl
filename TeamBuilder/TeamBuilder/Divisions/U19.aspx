<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="U19.aspx.cs" Inherits="TeamBuilder.Divisions.U19" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h2>Division <span class="label label-danger">U19</span></h2>
        <br />
                                ...
                                <tr>
                                    <td>
                                        <div class="container-team">
                                            ...
                                            <div class="row">
                                                <h5><%# Eval("PLAYER19") %>
                                                    <asp:LinkButton Visible='<%# !String.IsNullOrEmpty(Eval("PLAYER19").ToString()) %>' runat="server" ID="LinkButton29" CommandName="Delete" CommandArgument='<%# Eval("NAME") + "_19" %>' OnClientClick="if (!confirm('Are you sure do you want to delelte it?')) return false;"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></asp:LinkButton></h5>
                                            </div>
                                            <div class="row">
                                                <h5><%# Eval("PLAYER20") %>
                                                    <asp:LinkButton Visible='<%# !String.IsNullOrEmpty(Eval("PLAYER20").ToString()) %>' runat="server" ID="LinkButton30" CommandName="Delete" CommandArgument='<%# Eval("NAME") + "_20" %>' OnClientClick="if (!confirm('Are you sure do you want to delelte it?')) return false;"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></asp:LinkButton></h5>
                                            </div>
                                        </div>
                                    </td>
                            </ItemTemplate>
